...
public class Main {
	...
	public static void main(String[] args) {
		// arrays 클래스 : 배열 복사, 항목 정렬, 항목 검색

		// 배열 복사 : Arrays.copyOf / Arrays.copyOfRange
		...
		// 방법3
		char[] arr4 = Arrays.copyOfRange(arr3, 1, 3);
		...
		System.out.println("1차 배열 항몫값 비교 : " + Arrays.equals(original, cloned1));
		...
		System.out.println("1차 배열 항몫값 비교 : " + Arrays.equals(original, cloned2));
		System.out.println("중첩 배열 항목값 비교 : " + Arrays.deepEquals(original, cloned2));

		System.out.println();

		/*
		 * 배열 항목 정렬 - 기본 타입(int, double, char...) 또는 String 타입인 경우엔 자동으로 오름차순 정렬된다. -
		 * 사용자 정의 class 타입일 경우에는 클래스가 comparable () 구현하고 있어야 정렬이 된다.
		 */
		...
		// Array.sort() 통해 정렬 후 Arrays.binarySearch() 항목 찾음

		int[] scores1 = { 99, 97, 98 };
		Arrays.sort(scores1);
		int index = Arrays.binarySearch(scores1, 99);
		// Arrays.binarySearch(어떤 배열에서, 어떤 값을 원하는지);
		...
		System.out.println("찾은 인댁스 :" + index);
